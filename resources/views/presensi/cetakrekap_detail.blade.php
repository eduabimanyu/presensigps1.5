...
<body class="A4 landscape" >
    ...
    <section class="sheet padding-10mm">
        ...
        <table style="width: 100%">
            <tr>
                <td style="width:150px;">
                    <img src="{{ asset('assets/img/logo_perumdaau.png') }}" width="120" height="100%" alt="">
                </td>
                <td>
                    <span id="title">
                    ...
                    <span><i>Taman Cirendang, Jl. Siliwangi No.9 Cirendang, Kuningan.</i></span>
                </td>
            </tr>
        </table>
        ...
        <h4 class="tabelpresensi">Keterangan Libur :</h4>
        <ol>
            @foreach ($harilibur as $d)
                <li>{{ date('d-m-Y', strtotime($d->tanggal_libur)) }} - {{ $d->keterangan }}</li>
            @endforeach
        </ol>
        <table width="100%" style="margin-top:100px; font-family: Arial, Helvetica, sans-serif; font-size:13px;">
            <tr>
                <td></td>
                <td style="text-align: center">Kuningan, {{ date('d-m-Y') }}</td>
            </tr>
            <tr>
